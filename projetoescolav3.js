...
while (tentativasSenha < 3) {
  ...
  if (senhaDigitada === senhaCorreta) {
    console.log("Senha correta!. Acesso concluído.");

    break;
  } else {
    tentativasSenha++;
    console.log(
      `Senha incorreta. Você tem ${3 - tentativasSenha} tentativas restantes.`
    );
  }
  ...
  do {
    ...
    switch (opcao) {
      ...
      case "4":
        let nomeCursoExcluir = prompt(
          "Digite o nome do curso a ser excluído: "
        );
